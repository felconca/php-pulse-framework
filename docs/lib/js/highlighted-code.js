 ...
 */ !(function (e, n) {
  var t,
    a = (function () {
          ...
          ((e) => {
            if (Array.isArray(e.begin)) {
              if (e.skip || e.excludeBegin || e.returnBegin)
                throw (H("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), K);
              if ("object" != typeof e.beginScope || null === e.beginScope) throw (H("beginScope must be object"), K);
              W(e, e.begin, { key: "beginScope" }), (e.begin = y(e.begin, { joinWith: "" }));
            }
          })(e),
          ((e) => {
            if (Array.isArray(e.end)) {
              if (e.skip || e.excludeEnd || e.returnEnd)
                throw (H("skip, excludeEnd, returnEnd not compatible with endScope: {}"), K);
              if ("object" != typeof e.endScope || null === e.endScope) throw (H("endScope must be object"), K);
              W(e, e.end, { key: "endScope" }), (e.end = y(e.end, { joinWith: "" }));
            }
          })(e);
      }
      function q(e) {
        ...
        class t {
          ...
          compile() {
            ...
            (this.matcherRe = n(y(e, { joinWith: "|" }), !0)), (this.lastIndex = 0);
          }
          exec(e) {
          ...
          (function t(i, s) {
            ...
            return (
              "object" == typeof i.keywords &&
                i.keywords.$pattern &&
                ((i.keywords = Object.assign({}, i.keywords)), (l = i.keywords.$pattern), delete i.keywords.$pattern),
              (l = l || /\w+/),
              ...
              (i.contains = [].concat(
                ...i.contains.map((e) =>
                  ((e) => (
                    e.variants &&
                      !e.cachedVariants &&
                      (e.cachedVariants = e.variants.map((n) => r(e, { variants: null }, n))),
                    e.cachedVariants
                      ? e.cachedVariants
                      : J(e)
      ...
      var ne = ((e) => {
        ...
        function y(e, t, i, r) {
          ...
          function c() {
            ...
            for (; n; ) {
              ...
              if (r) {
                const [e, a] = r;
                if ((A.addText(t), (t = ""), (l[i] = (l[i] || 0) + 1), l[i] <= 7 && (O += a), e.startsWith("_")))
                  t += n[0];
                else {
            ...
            null != k.subLanguage
              ? (() => {
                  ...
                  if ("string" == typeof k.subLanguage) {
                    ...
                    (e = y(k.subLanguage, S, !0, N[k.subLanguage])), (N[k.subLanguage] = e._top);
                  } else e = E(S, k.subLanguage.length ? k.subLanguage : null);
                  k.relevance > 0 && (O += e.relevance), A.addSublanguage(e._emitter, e.language);
                })()
              : c(),
              (S = "");
          }
          ...
          function b(e, n) {
            return (
              e.scope && "string" == typeof e.scope && A.openNode(v.classNameAliases[e.scope] || e.scope),
              e.beginScope &&
                (e.beginScope._wrap
                  ? (A.addKeyword(S, v.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = ""))
          ...
          function f(n, r) {
            ...
            if ("begin" === p.type && "end" === r.type && p.index === r.index && "" === o) {
            ...
            if (((p = r), "begin" === r.type))
              return ((e) => {
                ...
                for (const t of r) if (t && (t(e, i), i.isMatchIgnored)) return m(n);
                return (
                  t.skip ? (S += n) : (t.excludeBegin && (S += n), g(), t.returnBegin || t.excludeBegin || (S = n)),
                  b(t, e),
            ...
            if ("end" === r.type) {
              const e = (function (e) {
                ...
                k.endScope && k.endScope._wrap
                  ...
                  : r.skip
                  ? (S += n)
                  : (r.returnEnd || r.excludeEnd || (S += n), g(), r.excludeEnd && (S = n));
                do {
                  k.scope && A.closeNode(), k.skip || k.subLanguage || (O += k.relevance), (k = k.parent);
                } while (k !== i.parent);
          ...
          try {
            for (k.matcher.considerAll(); ; ) {
              R++, T ? (T = !1) : k.matcher.considerAll(), (k.matcher.lastIndex = M);
            ...
            return (
              ...
              A.finalize(),
              (w = A.toHTML()),
              { language: e, value: w, relevance: O, illegal: !1, _emitter: A, _top: k }
            );
          } catch (n) {
            ...
            if (s) return { language: e, value: V(t), illegal: !1, relevance: 0, errorRaised: n, _emitter: A, _top: k };
            throw n;
          }
        }
        function E(e, t) {
          ...
          const a = ((e) => {
              const n = { value: V(e), illegal: !1, relevance: 0, _top: l, _emitter: new d.__emitter(d) };
        ...
        function v(e) {
          ...
          const t = ((e) => {
            ...
            if (t) {
              const n = _(t[1]);
              return (
                n || (F(o.replace("{}", t[1])), F("Falling back to no-highlight mode for this block.", e)),
                n ? t[1] : "no-highlight"
              );
            }
        ...
        let x = !1;
        function w() {
          "loading" !== document.readyState ? document.querySelectorAll(d.cssSelector).forEach(v) : (x = !0);
        }
        function _(e) {
        ...
        "undefined" != typeof window &&
          ...
          Object.assign(e, {
            ...
            registerLanguage: (t, a) => {
              ...
              try {
                ...
                if ((H("Language definition for '{}' could not be registered.".replace("{}", t)), !s)) throw e;
                H(e), (i = l);
              }
              i.name || (i.name = t),
                (n[t] = i),
          ...
          (e.regex = { concat: h, lookahead: g, either: m, optional: b, anyNumberOfTimes: u });
  ...
  (e.exports = a) /*! `css` grammar compiled for Highlight.js 11.5.0 */,
        ...
        return {
          ...
          contains: [
            ...
            o.ATTRIBUTE_SELECTOR_MODE,
            {
              ...
              variants: [{ begin: ":(" + t.join("|") + ")" }, { begin: ":(:)?(" + a.join("|") + ")" }],
            },
            o.CSS_VARIABLE,
    ...
    a.registerLanguage("css", t) /*! `javascript` grammar compiled for Highlight.js 11.5.0 */,
    (() => {
      var e = (() => {
        ...
        return (l) => {
          const c = l.regex,
            ...
            p = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: u, contains: [] },
            f = {
              begin: "html`",
              end: "",
              starts: { end: "`", returnEnd: !1, contains: [l.BACKSLASH_ESCAPE, p], subLanguage: "xml" },
            },
            y = {
              begin: "css`",
              end: "",
              starts: { end: "`", returnEnd: !1, contains: [l.BACKSLASH_ESCAPE, p], subLanguage: "css" },
            },
            E = { className: "string", begin: "`", end: "`", contains: [l.BACKSLASH_ESCAPE, p] },
            v = {
              className: "comment",
              variants: [
                l.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
          ...
          p.contains = x.concat({ begin: /\{/, end: /\}/, keywords: u, contains: ["self"].concat(x) });
          const w = [].concat(v, p.contains),
            _ = w.concat([{ begin: /\(/, end: /\)/, keywords: u, contains: ["self"].concat(w) }]),
            k = {
              className: "params",
              begin: /\(/,
              end: /\)/,
            ...
            O = {
              match: c.concat(/\b/, ((M = [...r, "super"]), c.concat("(?!", M.join("|"), ")")), d, c.lookahead(/\(/)),
          ...
          return {
            ...
            contains: [
                    ...
                    contains: [
                      {
                        ...
                        variants: [
                          ...
                          { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: u, contains: _ },
                        ],
                      },
                    ],
                  },
              ...
              { beginKeywords: "while if switch catch for" },
              {
                ...
                returnBegin: !0,
                label: "func.def",
                contains: [k, l.inherit(l.TITLE_MODE, { begin: d, className: "title.function" })],
              },
              { match: /\.\.\./, relevance: 0 },
              R,
              { match: "\\$" + d, relevance: 0 },
      ...
      var e = (() => {
        ...
        return (a) => {
          const i = l(a),
            ...
            c = { beginKeywords: "namespace", end: /\{/, excludeEnd: !0, contains: [i.exports.CLASS_REFERENCE] },
            d = {
          ...
          return (
            ...
            b(i, "use_strict", { className: "meta", relevance: 10, begin: /^\s*['"]use strict['"]/ }),
...
class u extends HTMLTextAreaElement {
  ...
  static insertText(e) {
    ...
    try {
      if (!(e ? document.execCommand("insertText", !1, e) : document.execCommand("delete"))) throw event;
    } catch (t) {
  ...
  static useTheme(e) {
    d ||
      ...
      d.addEventListener("load", () => {
        for (const e of document.querySelectorAll(`textarea[is="${t}"]`)) m.call(e);
      })),
      (d.href = e.includes(".") ? e : `https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.5.0/styles/${e}.min.css`);
  }
  constructor() {
    super(), (this.idle = 0);
  ...
  attributeChangedCallback(e, n, t) {
    switch (e) {
      case "auto-height":
        (this.style.height = null), null != t && ((this.value = this.value.trimEnd()), h.call(this));
        break;
      case "disabled":
      ...
      case "language":
        let e = "hljs";
        t && (e += " language-" + t), (a.get(this).querySelector("code").className = e);
        break;
      case "tab-size":
  ...
  oninput() {
    ...
    const e = (this.idle = o(() => {
      ...
      t || (r.className = "hljs"),
        (r.innerHTML = (t ? n.highlight(i, { language: t }) : n.highlightAuto(i)).value + "<br>"),
        this.onscroll(),
  ...
  onscroll() {
    ...
    (t.scrollTop = e),
      (t.scrollLeft = n),
      c && "scrollLeftMax" in t && (this.scrollLeft = Math.min(n, t.scrollLeftMax));
  }
}
if (!customElements.get(t)) {
  const e = (e) => {
    for (const { target: n } of e) {
      const e = a.get(n),
        { border: t, font: i, letterSpacing: r, lineHeight: s, padding: o, wordSpacing: l } = getComputedStyle(n),
...
function h() {
  ...
  const { boxSizing: e, borderTop: n, borderBottom: t, paddingTop: a, paddingBottom: i } = getComputedStyle(this),
